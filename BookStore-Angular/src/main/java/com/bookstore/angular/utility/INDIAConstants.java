package com.bookstore.angular.utility;
...
public class INDIAConstants {
	...
	public final static List<String> listOfUSStatesCode = new ArrayList<>(mapOfINDIAStates.keySet());
	public final static List<String> listOfUSStatesName = new ArrayList<>(mapOfINDIAStates.values());
